...
<html lang="en">
  ...
  <body>
    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{route('prak11.index')}}">Produks</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{route('prak11.logout')}}">Logout</a>
        </li>
    </ul>
    <form class="form-inline my-2 my-lg-0">
        <input id="cx" class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
        <button class="btn btn-outline-success my-2 my-sm-0" type="button" id="caridata">Search</button>
    </form>
    </div>
    </nav>
    </div>
